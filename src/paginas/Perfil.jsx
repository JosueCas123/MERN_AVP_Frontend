...
export const Perfil = () => {
  ...
  return (
    <>
        ...
        <p className="text-xl mt-5 mb-10 text-center">Modofica tu {" "} <span           className="text-indigo-600 font-bold">Informacion aqui </span>
        </p>
