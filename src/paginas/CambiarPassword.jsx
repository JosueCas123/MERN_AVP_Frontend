...
export const CambiarPassword = () => {
  ...
  const handleSubmit =async (e) => {
   ...
   if(password.pwd_nuevo.length < 6){
    ...
    setAlerta({
      msg:'El password debe de contener almenos 6 caracteres',
      error:true
    })
  ...
  return (
    <>
      ...
      <p className="text-xl mt-5 mb-10 text-center">Modofica tu {" "} <span className="text-indigo-600 font-bold">Password</span></p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-3">
                        ...
                        <input 
                          ...
                          className="border bg-gray-50 w-full pt-2 mt-5 rounded-lg"
                          name="pwd_nuevo"
                          placeholder="Ingresa un password nuevo"
                          onChange={e => setPassword({
                            ...password,
                            [e.target.name]: e.target.value
                          })}
